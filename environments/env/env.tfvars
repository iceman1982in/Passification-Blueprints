subscription_id = "__terraformSubscription__"
...
resource_groups = {
  ...
  common = {
    name              = "ava-mod-demo-002-common-rg"
    enabled           = true
    reuse             = false // false => will deploy the resource ; true => if the resource group exists
...
privateendpoint_dockerregistry= { 
     dockerregistryprd = {
      ...
      name = "..-dockerreg-pe"  // TO-DO: how to follow naming convention
      key = "prod" // TO-DO: what's this for ?
      dns_zone_group_name = "" // TO-DO: what's this for ?
...
privateendpoint_kv= {
  kvep1 = {
      resource_group_key = "common"  // TO-DO: can we reuse the same resource group key from the keyvault itself? 
